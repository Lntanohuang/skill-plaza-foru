...
一个无需 npm 的本地静态页面，以浅蓝白底、角色入口和资源卡片展示产教领域的 4 个公开 SKILL。
...
2026-09-15：目录更新为 4 个业务分类，每类 1 个 SKILL；4 个 GitHub 仓库均可公开读取。JavaScript 语法、分类数量、必填字段和 diff 空白检查通过，并在本地预览中验证分类筛选、详情渲染及安装提示词/最小输入示例的独立复制反馈。
